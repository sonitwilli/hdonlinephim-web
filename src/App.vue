<template>
  <div class="off-canvas-wrapper">
      <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper v-bind:class="{ 'is-open-left': menuStatus }">
          <!--header-->
          <div class="off-canvas position-left light-off-menu" id="offCanvas-responsive" data-off-canvas>
              <div class="off-menu-close">
                  <h3>Menu</h3>
                  <span data-toggle="offCanvas-responsive"></span>
              </div>
          ...
          <div id="content-data" class="off-canvas-content" data-off-canvas-content>
              <Header @menuStatusUpdated="menuStatus = $event"></Header>
